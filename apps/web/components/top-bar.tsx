...
export function TopBar() {
  ...
  return (
    <header className="h-14 border-b border-white/5 bg-[#080808]/60 backdrop-blur-md flex items-center justify-between px-6 z-20">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="p-2 text-white/30 hover:text-white/60 hover:bg-white/[0.05] rounded-lg transition-all"
          >
