    ...
    return (<div className="h-full overflow-auto scrollbar-thin p-6">
      ...
      {isLoading ? (<div className="space-y-3">
          ...
          {activities?.map((activity, i) => {
                ...
                return (<motion.div key={activity.id} initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: i * 0.05 }} className="glass-card-hover p-4 flex items-center gap-4">
          ...
          {(!activities || activities.length === 0) && (<div className="text-center py-20">
